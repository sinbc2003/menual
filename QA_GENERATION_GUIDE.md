...
| 챕터 | 제목 | 페이지 범위 | 현재 QA 수 | 목표 |
|-----|------|-----------|-----------|------|
| Ⅰ | 교원의 임용 | 3~100 | 55 | 800 |
| Ⅱ | 정원 및 순회교사제 | 101~118 | 5 | 100 |
| Ⅲ | 휴직 및 복직 | 119~256 | 19 | 600 |
| Ⅳ | 복무 | 257~336 | 21 | 500 |
| Ⅴ | 계약제교원 | 337~434 | 10 | 400 |
| Ⅵ | 평정 업무 | 435~526 | 5 | 400 |
| Ⅶ | 징계 및 직위해제 | 527~596 | 14 | 300 |
| Ⅷ | 승급 및 호봉획정 | 597~끝 | 4 | 200 |

**현재 총 130개 QA 생성 완료** → **목표: 5000개**

### 작업 방식
1. 전체 문서를 순회하면서 QA 생성 (1차 순회)
2. 5000개 미달 시 2차, 3차 순회 반복
3. 두 번째 순회부터는 기존 QA를 참고해서 다른 질문 생성
4. 질문이 많을 것 같은 부분(교원의 임용 등)에서 더 많은 질문 생성
